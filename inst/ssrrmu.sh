...
echo -e "$BARRA"
	stty erase '^H' && read -p "(Predeterminado: anonymous):" ssr_user
	[[ -z "${ssr_user}" ]] && ssr_user="anonymous"
...
echo -e "$BARRA"
	 read -p "(Predeterminado: anonymous):" ssr_password
	[[ -z "${ssr_password}" ]] && ssr_password="anonymous"
